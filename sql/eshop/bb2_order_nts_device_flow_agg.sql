...
(
    device_flow_agg_id bigint auto_increment comment '编号'
        primary key,
    subscriber_id      varchar(100) default '' null comment '设备ID',
    carrier            varchar(100) default '' null comment '服务商',
...
create index indexsubscriber_id
    on nts_device_flow_agg (subscriber_id);
